...
<div class="bg-blue-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl font-bold mb-4">Booking Ruang Kampus dengan Mudah</h1>
        <p class="text-xl mb-8 max-w-3xl mx-auto">Sistem pemesanan ruangan online untuk mahasiswa dan dosen</p>
...
<div class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">Fitur Kami</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition duration-200">
                ...
                <p class="text-gray-600">Lihat ketersediaan ruangan secara langsung dengan jadwal terupdate</p>
            </div>
            ...
            <div class="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition duration-200">
                ...
                <p class="text-gray-600">Booking ruangan hanya dalam 3 langkah mudah</p>
            </div>
            ...
            <div class="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition duration-200">
                ...
                <h3 class="text-xl font-semibold mb-2">Notifikasi Instan</h3>
                <p class="text-gray-600">Dapatkan pemberitahuan status booking via email</p>
            </div>
        </div>
    </div>
</div>
...
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">Cara Booking</h2>
        ...
        <div class="space-y-8 max-w-3xl mx-auto">
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-lg font-semibold mb-2">Login/Daftar Akun</h3>
                    <p class="text-gray-600">Gunakan akun kampus Anda untuk mengakses sistem</p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-lg font-semibold mb-2">Cek Ketersediaan</h3>
                    <p class="text-gray-600">Pilih tanggal dan waktu untuk melihat ruang yang tersedia</p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-lg font-semibold mb-2">Isi Form Booking</h3>
                    <p class="text-gray-600">Lengkapi data pemesanan dan submit</p>
                </div>
            </div>
        </div>
    </div>
